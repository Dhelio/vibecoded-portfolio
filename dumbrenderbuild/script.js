const translations = {
    en: {
        ...
        about_text: "Hello! My name is Alessandro; I consider myself a proactive generalist, specialized in Unity and Blender, but also with knowledge of .NET, C++, and Unreal. I am passionate about videogames and interactive development, but am not afraid of working with other technologies too;\n\nduring my carreer I've worked on many things: from Unity to Python, from modelling to level design. Here's a brief overview of my latest projects:",
    ...
    it: {
        ...
        about_text: "Ciao! Mi chiamo Alessandro; mi considero un generalista proattivo, specializzato in Unity e Blender, ma con conoscenze anche di .NET, C++ e Unreal. Sono appassionato di videogiochi e sviluppo interattivo, ma non ho paura di lavorare anche con altre tecnologie;\n\nnel corso della mia carriera ho lavorato su molte cose: da Unity a Python, dalla modellazione al level design. Ecco una breve panoramica dei miei ultimi progetti:",
